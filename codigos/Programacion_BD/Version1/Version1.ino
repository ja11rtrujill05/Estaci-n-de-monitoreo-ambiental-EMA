...
void loop() {
  //unsigned int  CO2 = myMHZ19.getCO2();
  //static int CO2=0; //variable CO2=0
  //CO2 = myMHZ19.getCO2();
  //Temp = myMHZ19.getTemperature();
  //Serial.println(CO2);
    N=String(n,2);
    Firebase.setString(firebaseData,rute1+"/humedad",N); //Escribe un valor entero en Firebase con la clave "humedad"
    Firebase.setInt(firebaseData,rute1+"/PM",PM++); //Escribe un valor entero en Firebase con la clave "humedad"
    Firebase.setInt(firebaseData,rute1+"/CO2",PM); //Escribe un valor entero en Firebase con la clave "humedad"
    Firebase.setString(firebaseData,rute1+  "/UV",N); //Escribe un valor entero en Firebase con la clave "temperatura"
    Firebase.setInt(firebaseData,rute1+  "/temperatura",Temp); //Escribe un valor entero en Firebase con la clave "temperatura"
  n+=0.11;
    display.clearDisplay();
    testdrawchar();
